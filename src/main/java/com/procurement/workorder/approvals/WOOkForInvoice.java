...
import com.interfaces.WOOkForInvoiceInterface;
import com.microsoft.playwright.Locator;
import com.microsoft.playwright.Page;

import java.util.Properties;

public class WOOkForInvoice implements WOOkForInvoiceInterface {
    Properties properties;
    Page page;
    LoginPageInterface loginPageInterface;
    LogoutPageInterface logoutPageInterface;
    public WOOkForInvoice(LoginPageInterface loginPageInterface, Properties properties, Page page, LogoutPageInterface logoutPageInterface){
        this.properties = properties;
        this.page = page;
        this.logoutPageInterface = logoutPageInterface;
        this.loginPageInterface = loginPageInterface;
    }
    public void WOOkForInvoiceMethod() throws InterruptedException {
...
//        }
        ...
        Thread.sleep(1000);
        page.locator("#btnOkforInvoice").click();
